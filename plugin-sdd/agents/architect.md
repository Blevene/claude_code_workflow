...
- Ensure design supports requirements and specs
...
Define what the system MUST do (for @spec-writer):

| Scenario | Given | When | Then |
|----------|-------|------|------|
| Valid login | Valid credentials | User submits | Return token |
| Invalid password | Wrong password | User submits | Return 401 |
...
| @spec-writer | Define behavioral contracts for specs |
...
### Behavioral Contracts for Specs
...
**Behavioral Contracts:** [count] for spec-writer
**Traceability:** Updated traceability_matrix.json

**For Handoff:**
- Design doc: [path]
- Key decisions: [summary]
- Next: @overseer review, then @spec-writer for specs
```
