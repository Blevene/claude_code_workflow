# FAANG Workflow Plugin for Claude Code

A Claude Code plugin that enforces enterprise-grade, test-driven development through a coordinated multi-agent team. Built for teams that want FAANG-level engineering discipline without the bureaucracy.
...
```bash
git clone https://github.com/YOUR_USERNAME/faang-workflow-plugin.git
```
...
cp -r faang-workflow-plugin ~/.claude/plugins/faang-workflow
```
...
```bash
alias claude='claude --plugin-dir ~/.claude/plugins/faang-workflow'
```
...
Then type `/help` - you should see the faang-workflow commands listed.
...
python ~/.claude/plugins/faang-workflow/tools/traceability_tools.py init traceability_matrix.json

# Validate traceability
python ~/.claude/plugins/faang-workflow/tools/traceability_tools.py validate traceability_matrix.json

# Check for gaps (missing tests, design, etc.)
python ~/.claude/plugins/faang-workflow/tools/traceability_tools.py check-gaps traceability_matrix.json

# Get summary
python ~/.claude/plugins/faang-workflow/tools/traceability_tools.py summary traceability_matrix.json --markdown
```
...
3. Check plugin structure:
   ```bash
   ls -la ~/.claude/plugins/faang-workflow/.claude-plugin/
...
```bash
claude --plugin-dir ~/.claude/plugins/faang-workflow
```
